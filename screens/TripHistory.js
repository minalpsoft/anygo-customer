...
export default function TripHistory({ navigation }) {
            ...
            <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
                ...
                <RideCard>
                    ...
                    <View style={styles.statusBadge}>
                        <Text style={styles.statusText}>19 NOV 2025 08:00 AM</Text>
                    </View>
    ...
    styles.navText,
    { color: 'green' }
  ]} onPress={() => navigation.navigate('CurrentTrip')}>On Going</Text>
                        </TouchableOpacity>
                    </View>
                ...
                <RideCard>
                    ...
                    <View style={styles.arrivalRow}>
                        ...
                        <TouchableOpacity style={styles.navBtn}>
                            <Text style={styles.navText} onPress={() => navigation.navigate('CurrentTrip')}>Completed</Text>
                        </TouchableOpacity>
                    </View>
